...
public class UserKick implements Command {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) {
        mySqlUserDAO.kick(createUser((String) req.getSession().getAttribute(NICK)),
                createUser(req.getParameter(NICK_KICK_USER)));
